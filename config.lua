...
Config.MinimumHouseRobberyPolice = 0 -- how many cops on to rob house
Config.MinimumTime = 1 -- what time to start robberies
Config.MaximumTime = 23 -- what time to end robberies
Config.Ped = "csb_reporter"  -- what ped model
Config.pedspawnchance = 1 -- how many % ped will spawn
Config.weapononechance = 50  -- % chance to have weapon one 
