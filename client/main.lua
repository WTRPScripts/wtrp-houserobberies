...
CreateThread(function()
    Wait(500)
    requiredItems = {
        [1] = {name = QBCore.Shared.Items["usb_house"]["name"], image = QBCore.Shared.Items["usb_house"]["image"]},
    }
	requiredItems2 = {
        [1] = {name = QBCore.Shared.Items["usb_house"]["name"], image = QBCore.Shared.Items["usb_house"]["image"]},
    }
	requiredItems3 = {
        [1] = {name = QBCore.Shared.Items["laptop_hack"]["name"], image = QBCore.Shared.Items["laptop_hack"]["image"]},
    }
